...
final public class In {
   ...
   /*
    * Luetaan käyttäjältä int-tyyppistä syötettä, kunnes käyttäjä suostuu
    * sellaisen antamaan.
    */
   ...
   /*
    * Luetaan käyttäjältä double-tyyppistä syötettä, kunnes käyttäjä suostuu
    * sellaisen antamaan.
    */
   ...
   /*
    * Luetaan käyttäjältä char-tyyppistä syötettä, kunnes käyttäjä suostuu
    * sellaisen antamaan.
    */
   ...
   /*
    * Luetaan käyttäjältä String-tyyppinen syöte, joka ei voi olla tyhjä
    * merkkijono ("").
    */
