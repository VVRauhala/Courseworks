 ...
 * <p>
 * null-arvoiset alkiot voivat olla joko sallittuja tai kiellettyj‰ rajapinnan
 * toteuttavan luokan tarpeiden mukaan.
 * <p>
...
public interface Lista {
   ...
   /**
    * Lis‰‰ annettuun linkitetyn listan kohtaan uuden solmun. Paikan vanha solmu
    * ja vanhaa solmua seuraavat solmut siirtyv‰t yhden paikan h‰nn‰n suuntaan.
    *
    * @param paikka
    *           lis‰yspaikka.
    * @param alkio
   ...
   /**
    * Poistaa annetusta paikasta solmun ja palauttaa poistetun solmun alkion.
    * Paluuarvo on null, mik‰li paikka oli virheelinen.
    *
    * @param paikka
    *           poistopaikka.
   ...
   /**
    * Palauttaa annetussa paikassa olevan solmun alkion. Mik‰li paikka on
    * virheellinen, paluuarvo on null.
    *
    * @param paikka
    *           solmun paikka listassa.
    * @return alkio tai null.
    */
   public abstract Object alkio(int paikka);

   /**
    * Korvaa annetussa paikassa olevan solmun tietoalkion parametrina annetulla
    * uudella tietoalkiolla. Palauttaa korvatun (eli solmun vanhan) tietoalkion,
    * jos paikka on kunnollinen. Paluuarvo on null, jos paikka on virheellinen.
    *
    * @param paikka
    *           solmun paikka listassa.
    * @param alkio
